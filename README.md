...
The PersonX dataset is generated by the synthetic data engine PersonX that can synthesise images under controllable cameras and environment. <br>
<br>
...
To provide data for “synthetic to real” study, we generate more diverse data and build two new datasets. One is used in [ViSDA2020 Chanllenge](http://ai.bu.edu/visda-2020/) and the other one is used in [Alice Benchmakrs](http://alice-challenge.site/). The main difference between the two data sets is that the environmental factor parameters of the latter are more complex.
